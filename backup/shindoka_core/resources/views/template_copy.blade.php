    ...
    <div class="page">
                            ...
                            <div class="main-notification-list">
                                ...
                                <div class="media">
                                    <div class="main-img-user"><img alt="avatar"
                                            src="{{ asset('/assets/img/users/2.jpg') }}"></div>
                                    <div class="media-body">
                    ...
                    <div class="dropdown main-header-notification">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <div class="main-notification-list">
                                <div class="media new">
                                    <div class="main-img-user online"><img alt="avatar"
                                            src="{{ asset('/assets/img/users/10.jpg') }}"></div>
                                    <div class="media-body">
                                ...
                                <div class="media">
                                    <div class="main-img-user online"><img alt="avatar"
                                            src="{{ asset('/assets/img/users/8.jpg') }}"></div>
                                    <div class="media-body">
                                ...
                                <div class="media">
                                    <div class="main-img-user online"><img alt="avatar"
                                            src="{{ asset('/assets/img/users/11.jpg') }}"></div>
                                    <div class="media-body">
                                            ...
                                            <div class="card-header border-bottom-0 pt-0 pl-0 pr-0 d-flex">
                                                <div>
                                                    <label class="main-content-label mb-2">Tasks</label> <span
                                                        ...
                                                        by
                                                        a set deadline, and
                                                        must contribute toward work-related objectives.</span>
                                                </div>
                                                <div class="ml-auto">
                                    ...
                                    <div class="list-card mb-0">
                                        <div class="d-flex">
                                            <div class="demo-avatar-group my-auto float-right">
                                                ...
                                                <div class="main-img-user avatar-xs">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ asset('/assets/img/users/8.jpg') }}">
                                                </div>
                                                <div class="Design">Design team</div>
                                            </div>
                                            <div class="ml-auto float-right">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-auto">
                                            <div class="mt-3">
                                                <div class="">
                                                    <img alt="" class="ht-50"
                                                        src="{{ asset('/assets/img/media/project-logo.png') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="main-footer text-center">
            <div class="container">
                <div class="row row-sm">
                    <div class="col-md-12">
                        <span>Copyright © 2021 <a href="#">Spruha</a>. Designed by <a
