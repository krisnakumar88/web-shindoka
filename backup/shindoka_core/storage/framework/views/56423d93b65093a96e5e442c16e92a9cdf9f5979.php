...
<script src="<?php echo e(asset('/assets/js/check-all-mail.js')); ?>"></script>

<!-- Internal Sweet-Alert js-->
<script src="<?php echo e(asset('/assets/plugins/sweet-alert/sweetalert.min.js')); ?>"></script>
<script src="<?php echo e(asset('/assets/plugins/sweet-alert/jquery.sweet-alert.js')); ?>"></script>
...
<script src="<?php echo e(asset('/assets/plugins/fileuploads/js/fileupload.j')); ?>s"></script>
...
<script src="<?php echo e(asset('/assets/plugins/telephoneinput/inttelephoneinput.js')); ?>"></script>

<?php echo $__env->yieldContent('script'); ?>
<?php /**PATH D:\BKAD MEDAN\laravel-shindoka\resources\views/layouts/script.blade.php ENDPATH**/ ?>