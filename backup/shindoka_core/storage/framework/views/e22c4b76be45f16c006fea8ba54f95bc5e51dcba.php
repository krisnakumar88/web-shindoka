            ...
            <div class="dropdown main-profile-menu">
                <a class="d-flex" href="">
                    <span class="main-img-user"><img alt="avatar"
                            src="<?php echo e(asset('/assets/img/users/1.jpg')); ?>"></span>
                </a>
                <div class="dropdown-menu">
                    <div class="header-navheading">
                        <h6 class="main-notification-title"><?php echo e(Auth::user()->name); ?></h6>
                        <p class="main-notification-text"><?php echo e(Auth::user()->role); ?></p>
                    </div>
                    <a class="dropdown-item border-top" href="<?php echo e(route('profile')); ?>">
            ...
            <div class="d-flex order-lg-2 ml-auto">
                    ...
                    <div class="dropdown-menu">
                        <a href="#" class="dropdown-item d-flex ">
                            <span class="avatar  mr-3 align-self-center bg-transparent"><img
                                    src="<?php echo e(asset('/assets/img/flags/french_flag.jpg')); ?>"
                                    alt="img"></span>
                            <div class="d-flex">
                        ...
                        <a href="#" class="dropdown-item d-flex">
                            <span class="avatar  mr-3 align-self-center bg-transparent"><img
                                    src="<?php echo e(asset('/assets/img/flags/germany_flag.jpg')); ?>"
                                    alt="img"></span>
                            <div class="d-flex">
                        ...
                        <a href="#" class="dropdown-item d-flex">
                            <span class="avatar mr-3 align-self-center bg-transparent"><img
                                    src="<?php echo e(asset('/assets/img/flags/italy_flag.jpg')); ?>"
                                    alt="img"></span>
                            <div class="d-flex">
                        ...
                        <a href="#" class="dropdown-item d-flex">
                            <span class="avatar mr-3 align-self-center bg-transparent"><img
                                    src="<?php echo e(asset('/assets/img/flags/russia_flag.jpg')); ?>"
                                    alt="img"></span>
                            <div class="d-flex">
                        ...
                        <a href="#" class="dropdown-item d-flex">
                            <span class="avatar  mr-3 align-self-center bg-transparent"><img
                                    src="<?php echo e(asset('/assets/img/flags/spain_flag.jpg')); ?>"
                                    alt="img"></span>
                            <div class="d-flex">
                        ...
                        <div class="main-notification-list">
                            <div class="media new">
                                <div class="main-img-user online"><img alt="avatar"
                                        src="<?php echo e(asset('/assets/img/users/5.jpg')); ?>"></div>
                            ...
                            <div class="media">
                                <div class="main-img-user"><img alt="avatar"
                                        src="<?php echo e(asset('/assets/img/users/2.jpg')); ?>"></div>
                                <div class="media-body">
                            ...
                            <div class="media">
                                <div class="main-img-user online"><img alt="avatar"
                                        src="<?php echo e(asset('/assets/img/users/3.jpg')); ?>"></div>
                                <div class="media-body">
                ...
                <div class="dropdown main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="main-notification-list">
                            ...
                            <div class="media">
                                <div class="main-img-user online"><img alt="avatar"
                                        src="/assets/img/users/8.jpg"></div>
                                <div class="media-body">
                ...
                <div class="dropdown main-profile-menu">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="/pages/signin">
...
<!-- Mobile-header closed --><?php /**PATH D:\BKAD MEDAN\laravel-shindoka\resources\views/layouts/header.blade.php ENDPATH**/ ?>