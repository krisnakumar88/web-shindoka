                                                ...
                                                <td class="text-center">
                                                    <div class="btn btn-list">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <form action="<?php echo e(route('dojo.destroy', $item->id)); ?>"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body pd-20 pd-sm-40">
                    ...
                    <div class="">
                        <form action="<?php echo e(route('dojo.store')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label class="">Nama Dojo</label>
                                <input class="form-control <?php $__errorArgs = ['nama_dojo'];
...
unset($__errorArgs, $__bag); ?>" required
                                    type="text" name="nama_dojo" value="<?php echo e(old('nama_dojo')); ?>">
                                <?php $__errorArgs = ['nama_dojo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 <?php $__errorArgs = ['id_pengcap'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__currentLoopData = $pengcab; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>">
                                            <?php echo e($item->nama_pengcap); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['id_pengcap'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-body pd-20 pd-sm-40">
                        ...
                        <div class="">
                            <form action="<?php echo e(route('dojo.update', $item->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required
                                        ...
                                        value="<?php echo e(old('nama_dojo', $item->nama_dojo)); ?>">
                                    <?php $__errorArgs = ['nama_dojo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $pengcab; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cabang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($item->pengcap->id == $cabang->id): ?>
                                                <option  selected value="<?php echo e($cabang->id); ?>">
                                                    <?php echo e($cabang->nama_pengcap); ?>

                                                </option>
                                            <?php else: ?>
                                                <option value="<?php echo e($cabang->id); ?>">
                                                    <?php echo e($cabang->nama_pengda); ?>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BKAD MEDAN\laravel-shindoka\resources\views/dojo/index.blade.php ENDPATH**/ ?>