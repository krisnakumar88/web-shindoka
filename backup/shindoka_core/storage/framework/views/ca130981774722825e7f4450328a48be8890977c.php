                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($item->dojo->nama_dojo); ?></td>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn btn-list">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <form action="<?php echo e(route('admin.destroy', $item->id)); ?>"
...
unset($__errorArgs, $__bag); ?>" name="id_dojo">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-body pd-20 pd-sm-40">
                        ...
                        <div class="">
                            <form action="<?php echo e(route('admin.update', $item->id)); ?>" method="post">
...
unset($__errorArgs, $__bag); ?>" required
                                        type="text" name="name" value="<?php echo e(old('name', $item->user->name)); ?>">
                                    <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" required
                                        type="text" name="username" value="<?php echo e(old('username', $item->user->username)); ?>">
                                    <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label class="">No. Hp</label>
                                        <input type="tel" name="no_hp" class="form-control" id="mobile-number" placeholder="" value="<?php echo e(old('no_hp', $item->no_hp)); ?>">
                                    <?php $__errorArgs = ['no_hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BKAD MEDAN\laravel-shindoka\resources\views/admin/index.blade.php ENDPATH**/ ?>